...
var roots = []string{config.FileName, "runs", "workgroups", "evaluations", "proposals", "reviews", "state/acquisitions", "state/connections", "state/retention", "state/audit", "state/execution-blocked.json", RestoreNote}
