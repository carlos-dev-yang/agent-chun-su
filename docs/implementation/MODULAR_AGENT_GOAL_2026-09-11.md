...
| MOD-02 | P2, P6, chat | Separate reception orchestration and task admission from transports; generalize the workgroup boundary | CLI/Telegram share the reception host; separate task attempts; existing mail/Jira contracts continue to pass | in_progress |
