...
| MOD-03 | P2, P7 | Separate agent driver, execution environment and compatibility evidence | Temporary Codex pin remains enforced; role-specific isolated packages; unsupported combinations fail explicitly | in_progress |
