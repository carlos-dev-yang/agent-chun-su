...
| MOD-05 | P9 | A bounded development-work module, starting with read-only review | Explicit repository/source scope, preserved revision/diff, report and evidence through the common host; no implicit external writes | in_progress |
