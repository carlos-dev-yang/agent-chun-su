...
| MOD-04 | P7 | Portable installation and operation on macOS and Linux/server | Target binaries, server secret integration, service configuration, Linux installation/runtime evidence and recovery guidance | in_progress |
